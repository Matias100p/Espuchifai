...
create table
    Banda(
        ...
        PRIMARY KEY (idBanda),
        CONSTRAINT FK_Banda_Album FOREIGN KEY (idAlbum) REFERENCES Album (idAlbum),
...
create Table
    Reproduccion(
        ...
        CONSTRAINT FK_Cliente_Reproduccion FOREIGN KEY (idCliente) REFERENCES Cliente (idCliente),
        CONSTRAINT FK_Cancion_Reproduccion FOREIGN KEY (idCancion) REFERENCES Cancion (idCancion)
    );